...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                   LT(2,KC_SPC), LT(3,KC_SPC), KC_SPC,           KC_RALT, XXXXXXX, XXXXXXX, MO(2),   KC_RCTL
    ),
    ...
    LAYOUT(
        ...
        _______,A(KC_F4), _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______, _______, _______,
        _______, _______, _______, KC_BSPC, KC_DEL,  _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_LCTL, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______,                   _______, _______, _______,          _______, KC_VOLD, KC_VOLU, _______, TG(1)
    ),
    ...
    LAYOUT(
        ...
        _______, _______, _______,                   _______, _______, KC_P0,            _______, _______, _______, _______, QK_BOOT
    )
};
